...
aliases: [vault as simulacrum, vault not copying self, framings of self]
kind: claim
status: seed
created: 2026-03-16
source:
...
Developed in a text exchange with Peter (2026-03-10): "I DO want to invoke that I'm not copying myself with the vault. I want to copy framings of myself as represented in my mapping/note-taking practice to mint certain 'shades'."

The Baudrillard reference helps sharpen this: if the vault is a simulacrum, the goal is phase 1 (faithful reflection) or a well-bounded phase 2, not phase 4 (pure self-referential model with no referent). The vault is accountable to the actual thought and practice it represents.

Implication for agent personas designed from a vault: such a persona inherits the framing, not the self.
