...
8. Compose Threads. This is the generative surface — the part of
   ...
   The handle is usually the pinned object. If a Thread exists to pin
   a phrase, make the phrase the handle; do not place the human's
   phrase inside a Thread whose handle is the agent's category for it.
