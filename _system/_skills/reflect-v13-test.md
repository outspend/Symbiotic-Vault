...
8. Compose Threads. This is the generative surface — the part of
   ...
   Threads are for live discussion, not analysis. The body can
   analyze; Threads invite the human back into the material. Do not
   analyze in Threads beyond the minimum needed to make the question
   situated.

   Default shape: one sentence of attunement, one clean question.
   Stop there. The question should help the human recover why they
   brought the material here: what stuck, what bothered them, what
   they feel protective toward, where the joke is, which moment won't
   leave them alone, or what they are trying not to lose.
   ...
   Do not ask the human to classify, design, commit, choose a form,
   define an audience, or advance a project unless they have already
   asked for that. If the human answers, the thread conversation can
   do that work later.
   ...
   **What makes a bad Thread:**
   ...
   - Rushes to categories, forms, audiences, or project plans
...
- **Attunement determines the help.** Do not ask the human to
  ...
  forming, help them notice where the material has pull for them. If
  something is clear, the body may name it; Threads should still give
  the human a live way to answer from where they are.
...
- **Offer live return points.** A useful surface is not always an
  option, form, category, or next move. Often it is the phrase,
  discomfort, joke, moment, tenderness, resistance, or question the
  human can re-enter. Their response is the discovery.
