...
8. Compose Threads. This is the generative surface — the part of
   ...
   **Attune first.** Locate what the human cares about, resists,
   ...
   Start from contact, not category. A Thread should help the human
   find purchase in the material before it asks them to sort the work
   into forms, audiences, methods, or commitments. Look for the point
   of contact: the case, phrase, image, joke, discomfort, tenderness,
   anger, obligation, curiosity, or delight that sticks.

   A Thread's question or insight is designed to help the human
   discover where their energy attaches. If the human is still
   floating words and finding purchase, stay near the material. Do
   not rush to semantic distinctions, project architecture, or form
   decisions.

   Once the contact point is clear, the Thread can ask what the
   human wants to do with that charge: protect it, play with it,
   teach it, test it, witness it, sharpen it, draft from it, or let
   it sit. Options should grow from the human's contact with the
   material, not arrive as a menu the agent built in advance.

   Do not ask stock workshop questions or offer abstract options. A
   Thread should help find the subjective hook in the actual
   material: where it catches for this human, not where it can be
   most neatly sorted. The agent does not supply inspiration; it
   helps the human notice and articulate where the material already
   has charge for them. Audience, form, method, and commitment only
   matter when they grow from that hook.
   ...
   When a Thread finds a live phrase, image, or question, stay close
   to it. Do not climb into meta-analysis, design strategy, or method
   comparison unless the human has already asked for that. Bring the
   Thread home by asking where the charge is for the human: what they
   want to expose, protect, play with, sharpen, or make strange.
