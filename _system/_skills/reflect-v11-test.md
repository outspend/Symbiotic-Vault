...
8. Compose Threads. This is the generative surface — the part of
   ...
   **Attune first.** Locate what the human cares about, resists,
   ...
   Threads are starters, not project diagnoses. A Thread should help
   the human find why they brought the material here before it asks
   them to classify, design, or commit. Respond to the human's
   revealed motive: frustration, tenderness, delight, protectiveness,
   embarrassment, play, dread, fascination, or the need to give
   something due respect.
