...
The journal entry sets the default diction and bearing of the
hold. The vault may ground the answer and candid, but it does
not set their default language. Stay near the journal's voice
unless the held item itself clearly asks for a different
register. Use the vault for grounding, not for bearing.
